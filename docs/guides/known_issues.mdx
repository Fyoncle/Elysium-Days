...
- Join the [Elysium Days Discord Server](https://discord.gg/WFpDr7zY8Z) and share your log by uploading it to [mclo.gs](https://mclo.gs).  
...
Refer to [this guide](https://github.com/Fyoncle/Elysium-Days/wiki/How-to-allocate-more-RAM) to learn how to allocate more RAM.  

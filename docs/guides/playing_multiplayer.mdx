...
> **Note:** You will need to refer to the [server installation guide](https://moddedmc.wiki/tr/project/elysium-days/docs/installation_guides/server_installation) in the Elysium Days wiki for the required server files.

...
3. A Cloudflare tunnel IP address will be displayed in the chat, share the IP with your friends for them to join that goes like `cloudflared://very-very-long-ip-with-random-words.com`

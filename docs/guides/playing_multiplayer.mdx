...
<Callout variant="info">
    You will need to refer to the [server installation guide](https://moddedmc.wiki/tr/project/elysium-days/docs/installation_guides/server_installation) on the wiki for the server files.
</Callout>

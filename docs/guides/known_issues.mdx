...
Broken fonts are usually caused by insufficient allocated RAM. Elysium Days requires **at least** 5 GB of RAM (6 GB is recommended). If less than 5 GB is allocated, the game won’t load properly.

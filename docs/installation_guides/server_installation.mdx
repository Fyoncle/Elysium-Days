...
<Callout variant="info">
    If you're using a hosting that already supports modpacks, specifically Elysium Days, only searching modpack's name and clicking Install will setup everything.
</Callout>

...
https://www.youtube.com/watch?v=WpViOvyu4eE
...
This launcher is **not supported**. But if you're that desperate to use it, you can still do with the [this method](https://moddedmc.wiki/en/project/elysium-days/docs/installation_guides/server_installation).

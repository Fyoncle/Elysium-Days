...
This launcher is **not supported** and a pain for playing modded. But if you're that desperate to use it, you can still do with [this method](https://moddedmc.wiki/en/project/elysium-days/docs/installation_guides/server_installation). Though I would recommend you to use any other launcher that is stated above, specially Modrinth or Prism.

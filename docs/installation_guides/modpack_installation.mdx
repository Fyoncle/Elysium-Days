...
*Since I don't use this launcher, here is a video:*  
[How to Install SKLauncher Download (Modpacks Tutorial](https://youtu.be/sJolPkDRTJk?t=556)
...
This launcher is **not supported** and a pain for modding. But if you're that desperate to use it, you can still do with [this method](https://moddedmc.wiki/en/project/elysium-days/docs/installation_guides/server_installation).
